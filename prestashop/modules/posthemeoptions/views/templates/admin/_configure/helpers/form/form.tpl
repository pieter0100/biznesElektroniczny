						...
						{else}
							...
							{block name="field"}
								...
								{elseif $input.type == 'image-select'}
							        <div class="image-select {if isset($input.direction)} image-select-{$input.direction}{/if}{if isset($input.class)}{$input.class}{/if}">
							            ...
							            {foreach $input.options.query AS $option }
							                ...
							                <div class="image-option">
							                    ...
							                    <img src="{$base_url}modules/posthemeoptions/img/{$option.img}" alt="{$option.name}"
								...
								<div class="form-group">
									<div class="row">
										<select class="pos-layouts fixed-width-xxl">
											...
											<option value="cosmetic5">Cosmetic 5</option>
											<option value="cosmetic6">Cosmetic 6</option>
											...
											<option value="fastfood1">Fastfood 1</option>
											...
											<option value="houseware4">Houseware 4</option>
											...
											<option value="megashop1">Megashop 1</option>
											<option value="megashop2">Megashop 2</option>
											<option value="megashop3">Megashop 3</option>
											<option value="megashop4">Megashop 4</option>								
