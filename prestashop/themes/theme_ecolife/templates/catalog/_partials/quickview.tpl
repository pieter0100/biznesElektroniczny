  ...
  <div class="modal-dialog" role="document">
   <div class="modal-content">
     ...
     <div class="modal-body">
      <div class="row">
        <div class="col-md-6">
			<div class="images-quickviews images-container js-images-container">
...
<script type="text/javascript">
	...
	$('.modal').on('shown.bs.modal', function (e) {
		$('.images-container .quickviews-for').slick("setPosition", 0);
		$('.images-container .quickviews-nav').slick("setPosition", 0);
	}); 
