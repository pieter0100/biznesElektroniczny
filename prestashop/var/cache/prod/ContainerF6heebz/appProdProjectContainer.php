...
class appProdProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = [
            ...
            'pscheckout\\infrastructure\\bootstrap\\install\\appleinstaller' => 'PsCheckout\\Infrastructure\\Bootstrap\\Install\\AppleInstaller',
        ...
        $this->fileMap = [
            'Monolog\\Handler\\HandlerInterface' => 'getHandlerInterfaceService.php',
            ...
            'PsCheckout\\Api\\Http\\CheckoutHttpClient' => 'getCheckoutHttpClientService.php',
            'PsCheckout\\Api\\Http\\Configuration\\CheckoutClientConfigurationBuilder' => 'getCheckoutClientConfigurationBuilderService.php',
            'PsCheckout\\Api\\Http\\Configuration\\OrderHttpClientConfigurationBuilder' => 'getOrderHttpClientConfigurationBuilderService.php',
            'PsCheckout\\Api\\Http\\Configuration\\OrderShipmentTrackingConfigurationBuilder' => 'getOrderShipmentTrackingConfigurationBuilderService.php',
            'PsCheckout\\Api\\Http\\OrderHttpClient' => 'getOrderHttpClientService.php',
            'PsCheckout\\Api\\Http\\OrderShipmentTrackingHttpClient' => 'getOrderShipmentTrackingHttpClientService.php',
            'PsCheckout\\Cache\\Array\\PayPalOrder' => 'getPayPalOrderService.php',
            'PsCheckout\\Cache\\Array\\ShippingTracking' => 'getShippingTrackingService.php',
            'PsCheckout\\Cache\\FileSystem\\PayPalOrder' => 'getPayPalOrder2Service.php',
            'PsCheckout\\Cache\\FileSystem\\ShippingTracking' => 'getShippingTracking2Service.php',
            'PsCheckout\\Core\\FundingSource\\Factory\\FundingSourceTokenFactory' => 'getFundingSourceTokenFactoryService.php',
            'PsCheckout\\Core\\OrderState\\Action\\ChangeOrderStateAction' => 'getChangeOrderStateActionService.php',
            'PsCheckout\\Core\\OrderState\\Action\\SetRefundedOrderStateAction' => 'getSetRefundedOrderStateActionService.php',
            'PsCheckout\\Core\\OrderState\\Service\\OrderStateMapper' => 'getOrderStateMapperService.php',
            'PsCheckout\\Core\\Order\\Builder\\Node\\AmountBreakdownNode' => 'getAmountBreakdownNodeService.php',
            'PsCheckout\\Core\\Order\\Builder\\Node\\ApplicationContextNodeBuilder' => 'getApplicationContextNodeBuilderService.php',
            'PsCheckout\\Core\\Order\\Builder\\Node\\BaseNodeBuilder' => 'getBaseNodeBuilderService.php',
            'PsCheckout\\Core\\Order\\Builder\\Node\\CardPaymentSourceNodeBuilder' => 'getCardPaymentSourceNodeBuilderService.php',
            'PsCheckout\\Core\\Order\\Builder\\Node\\GooglePayPaymentSourceNodeBuilder' => 'getGooglePayPaymentSourceNodeBuilderService.php',
            'PsCheckout\\Core\\Order\\Builder\\Node\\PayPalPaymentSourceNodeBuilder' => 'getPayPalPaymentSourceNodeBuilderService.php',
            'PsCheckout\\Core\\Order\\Builder\\Node\\PayerNodeBuilder' => 'getPayerNodeBuilderService.php',
            'PsCheckout\\Core\\Order\\Builder\\Node\\ShippingNodeBuilder' => 'getShippingNodeBuilderService.php',
            'PsCheckout\\Core\\Order\\Builder\\Node\\SupplementaryDataNodeBuilder' => 'getSupplementaryDataNodeBuilderService.php',
            'PsCheckout\\Core\\Order\\Builder\\OrderPayloadBuilder' => 'getOrderPayloadBuilderService.php',
            'PsCheckout\\Core\\PayPal\\Card3DSecure\\Card3DSecureValidator' => 'getCard3DSecureValidatorService.php',
            'PsCheckout\\Core\\PayPal\\OrderStatus\\Action\\PayPalCheckOrderStatusAction' => 'getPayPalCheckOrderStatusActionService.php',
            'PsCheckout\\Core\\PayPal\\Order\\Action\\RefundPayPalOrderAction' => 'getRefundPayPalOrderActionService.php',
            'PsCheckout\\Core\\PayPal\\Order\\Action\\UpdatePayPalOrderPurchaseUnitAction' => 'getUpdatePayPalOrderPurchaseUnitActionService.php',
            'PsCheckout\\Core\\PayPal\\Order\\Cache\\PayPalOrderCache' => 'getPayPalOrderCacheService.php',
            'PsCheckout\\Core\\PayPal\\Order\\Provider\\PayPalOrderProvider' => 'getPayPalOrderProviderService.php',
            'PsCheckout\\Core\\PayPal\\Refund\\Provider\\PayPalRefundOrderProvider' => 'getPayPalRefundOrderProviderService.php',
            'PsCheckout\\Core\\PayPal\\ShippingTracking\\Action\\AddTrackingAction' => 'getAddTrackingActionService.php',
            'PsCheckout\\Core\\PayPal\\ShippingTracking\\Action\\AddTrackingActionInterface' => 'getAddTrackingActionInterfaceService.php',
            'PsCheckout\\Core\\PayPal\\ShippingTracking\\Action\\ProcessExternalShipmentAction' => 'getProcessExternalShipmentActionService.php',
            'PsCheckout\\Core\\PayPal\\ShippingTracking\\Builder\\Node\\TrackingBaseNodeBuilder' => 'getTrackingBaseNodeBuilderService.php',
            'PsCheckout\\Core\\PayPal\\ShippingTracking\\Builder\\Node\\TrackingCarrierModuleNodeBuilder' => 'getTrackingCarrierModuleNodeBuilderService.php',
            'PsCheckout\\Core\\PayPal\\ShippingTracking\\Builder\\Node\\TrackingItemsNodeBuilder' => 'getTrackingItemsNodeBuilderService.php',
            'PsCheckout\\Core\\PayPal\\ShippingTracking\\Builder\\TrackingPayloadBuilder' => 'getTrackingPayloadBuilderService.php',
            'PsCheckout\\Core\\PayPal\\ShippingTracking\\Cache\\ShippingTrackingCache' => 'getShippingTrackingCacheService.php',
            'PsCheckout\\Core\\PayPal\\ShippingTracking\\Processor\\ExternalShipmentProcessor' => 'getExternalShipmentProcessorService.php',
            'PsCheckout\\Core\\PayPal\\ShippingTracking\\Processor\\ShipmentProcessor' => 'getShipmentProcessorService.php',
            'PsCheckout\\Core\\PayPal\\ShippingTracking\\Processor\\ShipmentProcessorInterface' => 'getShipmentProcessorInterfaceService.php',
            'PsCheckout\\Core\\PayPal\\ShippingTracking\\Service\\TrackingApiService' => 'getTrackingApiServiceService.php',
            'PsCheckout\\Core\\PayPal\\ShippingTracking\\Service\\TrackingDatabaseHandler' => 'getTrackingDatabaseHandlerService.php',
            'PsCheckout\\Core\\PayPal\\ShippingTracking\\Validator\\OrderTrackerValidator' => 'getOrderTrackerValidatorService.php',
            'PsCheckout\\Core\\PaymentToken\\Action\\DeletePaymentTokenAction' => 'getDeletePaymentTokenActionService.php',
            'PsCheckout\\Core\\Settings\\Configuration\\PayPalConfiguration' => 'getPayPalConfigurationService.php',
            'PsCheckout\\Core\\Webhook\\Service\\WebhookSecretToken' => 'getWebhookSecretTokenService.php',
            'PsCheckout\\Infrastructure\\Adapter\\Address' => 'getAddressService.php',
            'PsCheckout\\Infrastructure\\Adapter\\Cart' => 'getCartService.php',
            'PsCheckout\\Infrastructure\\Adapter\\Configuration' => 'getConfigurationService.php',
            'PsCheckout\\Infrastructure\\Adapter\\Context' => 'getContextService.php',
            'PsCheckout\\Infrastructure\\Adapter\\Country' => 'getCountryService.php',
            'PsCheckout\\Infrastructure\\Adapter\\Currency' => 'getCurrencyService.php',
            'PsCheckout\\Infrastructure\\Adapter\\Customer' => 'getCustomerService.php',
            'PsCheckout\\Infrastructure\\Adapter\\Language' => 'getLanguageService.php',
            'PsCheckout\\Infrastructure\\Adapter\\Link' => 'getLinkService.php',
            'PsCheckout\\Infrastructure\\Adapter\\ShopContext' => 'getShopContextService.php',
            'PsCheckout\\Infrastructure\\Adapter\\SystemConfiguration' => 'getSystemConfigurationService.php',
            'PsCheckout\\Infrastructure\\Adapter\\Tools' => 'getToolsService.php',
            'PsCheckout\\Infrastructure\\Adapter\\Validate' => 'getValidateService.php',
            'PsCheckout\\Infrastructure\\Bootstrap\\Install\\AppleInstaller' => 'getAppleInstallerService.php',
            'PsCheckout\\Infrastructure\\Bootstrap\\Install\\CompatibilityRulesInstaller' => 'getCompatibilityRulesInstallerService.php',
            'PsCheckout\\Infrastructure\\Bootstrap\\Install\\ConfigurationInstaller' => 'getConfigurationInstallerService.php',
            'PsCheckout\\Infrastructure\\Bootstrap\\Install\\DatabaseTableInstaller' => 'getDatabaseTableInstallerService.php',
            'PsCheckout\\Infrastructure\\Bootstrap\\Install\\FundingSourceInstaller' => 'getFundingSourceInstallerService.php',
            'PsCheckout\\Infrastructure\\Bootstrap\\Install\\Installer' => 'getInstaller4Service.php',
            'PsCheckout\\Infrastructure\\Bootstrap\\Install\\OrderStateInstaller' => 'getOrderStateInstallerService.php',
            'PsCheckout\\Infrastructure\\Environment\\Env' => 'getEnv3Service.php',
            'PsCheckout\\Infrastructure\\Environment\\EnvLoader' => 'getEnvLoaderService.php',
            'PsCheckout\\Infrastructure\\Logger\\LoggerFactory' => 'getLoggerFactoryService.php',
            'PsCheckout\\Infrastructure\\Logger\\LoggerFileFinder' => 'getLoggerFileFinderService.php',
            'PsCheckout\\Infrastructure\\Logger\\LoggerFileReader' => 'getLoggerFileReaderService.php',
            'PsCheckout\\Infrastructure\\Logger\\LoggerHandlerFactory' => 'getLoggerHandlerFactoryService.php',
            'PsCheckout\\Infrastructure\\Repository\\AddressRepository' => 'getAddressRepositoryService.php',
            'PsCheckout\\Infrastructure\\Repository\\CartRepository' => 'getCartRepositoryService.php',
            'PsCheckout\\Infrastructure\\Repository\\ConfigurationRepository' => 'getConfigurationRepositoryService.php',
            'PsCheckout\\Infrastructure\\Repository\\CountryRepository' => 'getCountryRepository2Service.php',
            'PsCheckout\\Infrastructure\\Repository\\CurrencyRepository' => 'getCurrencyRepository2Service.php',
            'PsCheckout\\Infrastructure\\Repository\\CustomerRepository' => 'getCustomerRepositoryService.php',
            'PsCheckout\\Infrastructure\\Repository\\FundingSourceRepository' => 'getFundingSourceRepositoryService.php',
            'PsCheckout\\Infrastructure\\Repository\\GenderRepository' => 'getGenderRepositoryService.php',
            'PsCheckout\\Infrastructure\\Repository\\LanguageRepository' => 'getLanguageRepository2Service.php',
            'PsCheckout\\Infrastructure\\Repository\\OrderHistoryRepository' => 'getOrderHistoryRepositoryService.php',
            'PsCheckout\\Infrastructure\\Repository\\OrderRepository' => 'getOrderRepositoryService.php',
            'PsCheckout\\Infrastructure\\Repository\\OrderStateRepository' => 'getOrderStateRepositoryService.php',
            'PsCheckout\\Infrastructure\\Repository\\PayPalCustomerRepository' => 'getPayPalCustomerRepositoryService.php',
            'PsCheckout\\Infrastructure\\Repository\\PayPalOrderAuthorizationRepository' => 'getPayPalOrderAuthorizationRepositoryService.php',
            'PsCheckout\\Infrastructure\\Repository\\PayPalOrderCaptureRepository' => 'getPayPalOrderCaptureRepositoryService.php',
            'PsCheckout\\Infrastructure\\Repository\\PayPalOrderMatrixRepository' => 'getPayPalOrderMatrixRepositoryService.php',
            'PsCheckout\\Infrastructure\\Repository\\PayPalOrderPurchaseUnitRepository' => 'getPayPalOrderPurchaseUnitRepositoryService.php',
            'PsCheckout\\Infrastructure\\Repository\\PayPalOrderRefundRepository' => 'getPayPalOrderRefundRepositoryService.php',
            'PsCheckout\\Infrastructure\\Repository\\PayPalOrderRepository' => 'getPayPalOrderRepositoryService.php',
            'PsCheckout\\Infrastructure\\Repository\\PaymentTokenRepository' => 'getPaymentTokenRepositoryService.php',
            'PsCheckout\\Infrastructure\\Repository\\PsAccountRepository' => 'getPsAccountRepositoryService.php',
            'PsCheckout\\Infrastructure\\Repository\\ShippingTrackingRepository' => 'getShippingTrackingRepositoryService.php',
            'PsCheckout\\Infrastructure\\Repository\\ShopRepository' => 'getShopRepository2Service.php',
            'PsCheckout\\Infrastructure\\Repository\\StateRepository' => 'getStateRepository2Service.php',
            'PsCheckout\\Infrastructure\\Validator\\MerchantValidator' => 'getMerchantValidatorService.php',
            'PsCheckout\\Module\\Presentation\\Translator' => 'getTranslatorService.php',
            'PsCheckout\\Presentation\\Presenter\\Date\\DatePresenter' => 'getDatePresenterService.php',
            'PsCheckout\\Presentation\\Presenter\\FundingSource\\FundingSourcePresenter' => 'getFundingSourcePresenterService.php',
            'PsCheckout\\Presentation\\Presenter\\FundingSource\\FundingSourceTokenPresenter' => 'getFundingSourceTokenPresenterService.php',
            'PsCheckout\\Presentation\\Presenter\\FundingSource\\FundingSourceTranslationProvider' => 'getFundingSourceTranslationProviderService.php',
            'PsCheckout\\Presentation\\Presenter\\FundingSource\\LogoPresenter' => 'getLogoPresenterService.php',
            'PsCheckout\\Presentation\\Presenter\\PayPalOrder\\PayPalOrderPresenter' => 'getPayPalOrderPresenterService.php',
            'PsCheckout\\Presentation\\Presenter\\PayPalOrder\\PayPalOrderTotalsPresenter' => 'getPayPalOrderTotalsPresenterService.php',
            'PsCheckout\\Presentation\\Presenter\\PayPalOrder\\PayPalOrderTransactionPresenter' => 'getPayPalOrderTransactionPresenterService.php',
            'PsCheckout\\Presentation\\Presenter\\Settings\\Admin\\AdminSettingsPresenter' => 'getAdminSettingsPresenterService.php',
            'PsCheckout\\Presentation\\Presenter\\Settings\\Admin\\Modules\\ConfigurationModule' => 'getConfigurationModuleService.php',
            'PsCheckout\\Presentation\\Presenter\\Settings\\Admin\\Modules\\ContextModule' => 'getContextModuleService.php',
            'PsCheckout\\Presentation\\Presenter\\Settings\\Admin\\Modules\\PaypalModule' => 'getPaypalModuleService.php',
            'PsCheckout\\Utility\\Common\\InputStreamUtility' => 'getInputStreamUtilityService.php',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => 'mysql', 'port' => '', 'dbname' => 'prestashop', 'user' => 'root', 'password' => 'admin', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))', 1013 => $this->getEnv('const:runtime:_PS_ALLOW_MULTI_STATEMENTS_QUERIES_')], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), $a, ['enum' => 'string']);
    }
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('module.upgrade', [0 => function () {
            return ${($_ = isset($this->services['mbo.event_subscriber.module_event_subscriber']) ? $this->services['mbo.event_subscriber.module_event_subscriber'] : $this->load('getMbo_EventSubscriber_ModuleEventSubscriberService.php')) && false ?: '_'};
        }, 1 => 'logModuleUpgrade'], 0);
        $instance->addListener('module.install', [0 => function () {
            return ${($_ = isset($this->services['mbo.event_subscriber.module_event_subscriber']) ? $this->services['mbo.event_subscriber.module_event_subscriber'] : $this->load('getMbo_EventSubscriber_ModuleEventSubscriberService.php')) && false ?: '_'};
        }, 1 => 'logModuleInstall'], 0);
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('V0NQaSxrNXP9cUDtz6hkVCJ2eV90H46mYFQdGYq5HDFocc7L3pYRgMQufsGQrJnb'))) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('V0NQaSxrNXP9cUDtz6hkVCJ2eV90H46mYFQdGYq5HDFocc7L3pYRgMQufsGQrJnb');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'modules_translation_paths': $value = [
                ...
                50 => ($this->targetDirs[3].'/modules/psxmarketingwithgoogle/translations'),
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.secret' => 'V0NQaSxrNXP9cUDtz6hkVCJ2eV90H46mYFQdGYq5HDFocc7L3pYRgMQufsGQrJnb',
